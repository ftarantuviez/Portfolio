            ...
            <div className="carousel-inner">
                ...
                <div className="carousel-caption d-none d-md-block">
                    ...
                    <div className="buttons-container m-3">
                        <a href="https://netflix-clone-93b61.web.app/" className="btn btn-primary mr-2" target="_blank" rel="noopener noreferrer">Description</a>
                        <Link className="btn btn-secondary" to="/">Web</Link>
                    </div>
                </div>
            </div>
